...
TT = np.array([[( 1, 'self.action0_0'),  (0, 'None')     , (0, 'None')     , (0, 'None')     , (0, 'None')      , (0, 'None')     , (0, 'None')     ],  #<---STATE0
...
class run_SM_GUI(SM_GUI.SM_GUI):
    ...
    def checkResetButton(self):
        global RESET
        logger.debug("parent: Reset button pressed ...")
        RESET = True
    ...
    def action1_1(self):
        ...
        next_E = 0
        SM_TEXT_TO_DIAPLAY = "S1,E0 -> action1_1\n" "\tpreprate to go to STATE2"
